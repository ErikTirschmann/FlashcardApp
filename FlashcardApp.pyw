...
if __name__ == '__main__':
    ...
    lb_infotx = ttk.Label(cn_button_fr, text = 'FlashCards 2.2 by Erik Tirschmann', width = 35, anchor = 'center', background = fr_color_db)
    lb_infotx.grid(column = 2, row = 0, padx = 5, pady = 5, ipady = 0)
    bt_help_fi = ttk.Button(cn_button_fr, text = '？', width = 3, command = show_help)
    bt_help_fi.grid(column = 3, row = 0, padx = 5, pady = 5, sticky = 'e')
    bt_backup = ttk.Button(cn_button_fr, text = '☁', width = 3, command = create_backup)
    bt_backup.grid(column = 4, row = 0, padx = 0, pady = 5, sticky = 'e')
    bt_toggle = ttk.Button(cn_button_fr, text = '⇊', width = 3, command = toggle_buttons)
    bt_toggle.grid(column = 5, row = 0, padx = 5, pady = 5, sticky = 'e')
    # hotfixes
